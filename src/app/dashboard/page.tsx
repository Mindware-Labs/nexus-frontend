  ...
  return (
    <div className="flex min-h-screen flex-col bg-nexus-deep text-white">
      <header className="border-b border-white/10 bg-nexus-deep/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          <div className="flex items-center gap-2.5">
            ...
            <span className="ml-2 rounded-full bg-nexus-purple/30 px-2.5 py-0.5 text-xs font-medium text-nexus-lavender">
              Owner
            </span>
          </div>
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-4 text-center">
        <h1 className="text-3xl font-bold">Panel de Owner</h1>
        <p className="text-white/50">Bienvenido, {user.name}. Tu dashboard se construirá aquí.</p>
      </main>
    </div>
  );
}
