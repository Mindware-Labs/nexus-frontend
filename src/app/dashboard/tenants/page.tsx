    ...
    <div className="flex flex-1 flex-col gap-6 p-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
        <div className="flex items-center gap-3 rounded-xl border bg-muted/30 px-4 py-3">
          ...
          <div>
            <p className="text-sm font-medium text-foreground">{tenants.length}</p>
        ...
        <div className="flex items-center gap-3 rounded-xl border bg-muted/30 px-4 py-3 col-span-2 sm:col-span-1">
          ...
          <div>
            <p className="text-sm font-medium text-foreground">{tenants.length - active}</p>
          ...
          <div className="flex flex-col items-center justify-center gap-3 py-16 text-center">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Usa el botón <span className="font-medium">Nuevo tenant</span> para crear el primero.
              </p>
            </div>
          </div>
        ) : (
