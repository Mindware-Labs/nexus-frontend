      ...
      <main className="flex-1 bg-nexus-deep text-white/90">
        <div className="mx-auto max-w-3xl px-5 pb-20 pt-28 sm:px-8">
          ...
          <div className="mb-8 flex items-center gap-3">
            <span className="grid size-10 place-items-center rounded-xl bg-gradient-to-br from-nexus-purple to-nexus-lavender shadow-lg shadow-nexus-purple/30 shrink-0">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-white/50">
                Mindware Labs, S.R.L. · República Dominicana
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <pre className="whitespace-pre-wrap text-sm leading-relaxed text-white/80 font-[inherit]">
              {policyText}
            </pre>
          </div>
          ...
          <div className="mt-8 rounded-xl border border-nexus-lavender/20 bg-nexus-purple/10 px-5 py-4 text-sm text-white/70">
            Para consultas sobre privacidad o ejercer tus derechos ARCO, escríbenos a{' '}
            <a
